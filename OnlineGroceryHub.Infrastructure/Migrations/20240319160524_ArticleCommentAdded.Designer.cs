...
namespace OnlineGroceryHub.Infrastructure.Migrations
{
    ...
    [Migration("20240319160524_ArticleCommentAdded")]
    partial class ArticleCommentAdded
    {
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishDate = new DateTime(2024, 3, 19, 18, 5, 23, 803, DateTimeKind.Local).AddTicks(6145),
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author = "Eva Selhub",
                            CommentDate = new DateTime(2024, 3, 19, 18, 5, 23, 803, DateTimeKind.Local).AddTicks(6243),
