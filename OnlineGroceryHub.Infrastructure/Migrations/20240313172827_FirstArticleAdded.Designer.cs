...
namespace OnlineGroceryHub.Infrastructure.Migrations
{
    ...
    [Migration("20240313172827_FirstArticleAdded")]
    partial class FirstArticleAdded
    {
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishDate = new DateTime(2024, 3, 13, 19, 28, 27, 408, DateTimeKind.Local).AddTicks(9376),
