...
namespace OnlineGroceryHub.Infrastructure.Migrations
{
    ...
    [Migration("20240317170255_NewPhotosForProducts")]
    partial class NewPhotosForProducts
    {
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishDate = new DateTime(2024, 3, 17, 19, 2, 54, 620, DateTimeKind.Local).AddTicks(6786),
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author = "Eva Selhub",
                            CommentDate = new DateTime(2024, 3, 17, 19, 2, 54, 620, DateTimeKind.Local).AddTicks(6897),
