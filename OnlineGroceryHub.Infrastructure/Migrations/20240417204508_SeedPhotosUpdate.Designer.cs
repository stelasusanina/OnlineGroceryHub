...
namespace OnlineGroceryHub.Infrastructure.Migrations
{
    ...
    [Migration("20240417204508_SeedPhotosUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishDate = new DateTime(2023, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author = "Eva Selhub",
                            CommentDate = new DateTime(2024, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Discount = 12,
                            ExpirationDate = new DateTime(2024, 9, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.ProductOrder", b =>
                {
                    ...
                    b.HasComment("Mapping table of Product and Order");
                });
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.UserOrder", b =>
                {
                    ...
                    b.HasComment("Mapping table of User and Order");
                });
            ...
            modelBuilder.Entity("OnlineGroceryHub.Infrastructure.Data.Models.ProductOrder", b =>
                {
                    b.HasOne("OnlineGroceryHub.Infrastructure.Data.Models.Order", "Order")
