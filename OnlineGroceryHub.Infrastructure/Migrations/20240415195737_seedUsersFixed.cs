    ...
    public partial class seedUsersFixed : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WishlistId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Wishlist identifier"),
                    ProductId = table.Column<int>(type: "int", nullable: false, comment: "Product identifier")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Eva Selhub", new DateTime(2024, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "Great article! Learned a lot from it!" });
